...
import { alpha, Box, Button, Card, CardActions, CardContent, CardMedia, Chip, Dialog, DialogActions, DialogContent, IconButton, Skeleton, Stack, TextField, Typography } from "@mui/material"
...
export function Project({ image, desc, title, id, servers, category, onEdit, onDelete, link }: IProject & Props) {
